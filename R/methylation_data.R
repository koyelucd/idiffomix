#' @title Methylation array data for patients suffering from breast cancer
#'
#' @description A dataset containing simulated methylation array data for \eqn{C} CpG sites associated to \eqn{G} genes, from \eqn{R=2} sample types, collected from \eqn{N=4} patients.
#'
#' @details
...
#' @format A data frame with 205 rows and 10 columns.
#' \itemize{
